...
CREATE  TABLE plastikoo2.utilisateur_role ( 
	...
	CONSTRAINT fk_utilisateur_role_utilisateur FOREIGN KEY ( id_utilisateur ) REFERENCES plastikoo2.utilisateur( id ) ON DELETE NO ACTION ON UPDATE NO ACTION
...
BEGIN
    ...
    BEGIN
        -- Handle exception by rolling back if needed and exiting
        ROLLBACK;
        RESIGNAL; -- Re-throw the exception to propagate it
    END;    
...
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 1, 'RANDRIANARISON', 'Johns Irintsoa', 'johnsirintsoa18@gmail.com', 'JIrintsoa', '1234Jo', '2002-09-18', 400, '1234', 4, '2024-08-08 04.16.49 PM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 2, 'Jane', 'Doe', 'jane.doe@example.com', 'janedoe', 'password2', '1991-02-01', 100, '5678', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 3, 'Alice', 'Smith', 'alice.smith@example.com', 'alicesmith', 'password3', '1992-03-01', 100, '9101', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 4, 'Bob', 'Johnson', 'bob.johnson@example.com', 'bobjohnson', 'password4', '1993-04-01', 100, '1121', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 5, 'Charlie', 'Brown', 'charlie.brown@example.com', 'charlieb', 'password5', '1994-05-01', 100, '3141', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 6, 'David', 'Davis', 'david.davis@example.com', 'davidd', 'password6', '1995-06-01', 100, '5161', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 7, 'Eva', 'Martinez', 'eva.martinez@example.com', 'evam', 'password7', '1996-07-01', 100, '7181', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 8, 'Frank', 'Garcia', 'frank.garcia@example.com', 'frankg', 'password8', '1997-08-01', 100, '9201', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 9, 'Grace', 'Hernandez', 'grace.hernandez@example.com', 'graceh', 'password9', '1998-09-01', 100, '1223', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 10, 'Hank', 'Wilson', 'hank.wilson@example.com', 'hankw', 'password10', '1999-10-01', 100, '3245', 0, '2025-01-01 02.59.59 AM', null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 11, 'Nolan', 'Jackson', 'johns.irintsoa@gmail.com', 'Nolan18', '123Nolan', '2000-08-26', 0, 'XXXX', 0, null, null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 13, 'George', 'Jack', 'george@gmail.com', null, '$2b$10$1MN2QPtoKjsCzJxHyltfPOzpGQ5JbPVwGw/FRLfrE./fdyeSv5Eki', '2000-08-26', 1000, 'XXXX', 0, null, null, null);
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil, id_google ) VALUES ( 14, 'King', 'Joe', 'joeyking@gmail.com', null, '$2b$10$/AN3G7iWcIFhKiwXqvz8reBB1I38l5LWR1klqV06Xu.465rBhx5UC', '2002-08-26', 0, 'XXXX', 0, null, null, null);
...
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 1, 'Sustainable Living Tips', 'Content about living sustainably with small changes.', 1, '2024-08-13 12.11.25 PM', 'http://example.com/sustainable-living-tips', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 2, 'Top 10 Travel Destinations', 'A guide to the top 10 travel destinations for 2024.', 2, '2024-08-13 12.11.25 PM', 'http://example.com/top-10-travel-destinations', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 3, 'Healthy Eating Habits', 'How to develop healthy eating habits in your daily life.', 3, '2024-08-13 12.11.25 PM', 'http://example.com/healthy-eating-habits', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 4, 'The Future of Technology', 'Exploring the future trends in technology.', 4, '2024-08-13 12.11.25 PM', 'http://example.com/future-of-technology', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 5, 'Financial Independence', 'Steps to achieving financial independence.', 5, '2024-08-13 12.11.25 PM', 'http://example.com/financial-independence', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 6, 'Outdoor Adventures', 'The best outdoor adventures to try in 2024.', 6, '2024-08-13 12.11.25 PM', 'http://example.com/outdoor-adventures', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 7, 'The Art of Minimalism', 'Understanding and practicing minimalism in life.', 7, '2024-08-13 12.11.25 PM', 'http://example.com/art-of-minimalism', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 8, 'Fitness Tips for Beginners', 'Essential fitness tips for those just starting out.', 8, '2024-08-13 12.11.25 PM', 'http://example.com/fitness-tips-for-beginners', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 9, 'Home Gardening 101', 'A beginner’s guide to starting a home garden.', 9, '2024-08-13 12.11.25 PM', 'http://example.com/home-gardening-101', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 10, 'Digital Nomad Lifestyle', 'What it takes to live a digital nomad lifestyle.', 10, '2024-08-13 12.11.25 PM', 'http://example.com/digital-nomad-lifestyle', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 11, 'Eco-Friendly Products', 'Review of the best eco-friendly products in 2024.', 1, '2024-08-13 12.11.25 PM', 'http://example.com/eco-friendly-products', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 12, 'Mindfulness Meditation', 'Benefits and practices of mindfulness meditation.', 2, '2024-08-13 12.11.25 PM', 'http://example.com/mindfulness-meditation', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 13, 'Investing for Beginners', 'A beginner’s guide to investing in the stock market.', 3, '2024-08-13 12.11.25 PM', 'http://example.com/investing-for-beginners', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 14, 'Creative Writing Tips', 'How to get started with creative writing.', 4, '2024-08-13 12.11.25 PM', 'http://example.com/creative-writing-tips', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 15, 'DIY Home Improvement', 'Easy DIY projects to improve your home.', 5, '2024-08-13 12.11.25 PM', 'http://example.com/diy-home-improvement', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 16, 'Social Media Marketing', 'Effective social media marketing strategies.', 6, '2024-08-13 12.11.25 PM', 'http://example.com/social-media-marketing', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 17, 'Sustainable Fashion', 'How to make sustainable fashion choices.', 7, '2024-08-13 12.11.25 PM', 'http://example.com/sustainable-fashion', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 18, 'Remote Work Challenges', 'Overcoming the challenges of remote work.', 8, '2024-08-13 12.11.25 PM', 'http://example.com/remote-work-challenges', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 19, 'Personal Development Goals', 'Setting and achieving personal development goals.', 9, '2024-08-13 12.11.25 PM', 'http://example.com/personal-development-goals', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 20, 'Climate Change Awareness', 'Raising awareness about climate change and its impacts.', 10, '2024-08-13 12.11.25 PM', 'http://example.com/climate-change-awareness', 0);
INSERT INTO plastikoo2.publication( id, titre, contenu, id_utilisateur, date_creation, lien, est_valide ) VALUES ( 21, 'Plastikoo OSC final', 'hellloweijjfofjewofeof', 13, '2024-09-04 04.27.48 AM', 'forum-528891805.png', 0);
...
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 62, 2000, 'RCLT106998162240816110845', 1, 2, '2024-08-16 03.00.00 AM', null, null, 8, 2, '010632', 0.0, 0.0);
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 63, 5000, 'BA585956826240816110811', 1, 7, '2024-08-16 03.00.00 AM', null, null, 4, 3, 'XXXXXX', 0.0, 0.2);
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 64, 2200, 'RTT355545622240816110824', 1, 7, '2024-08-16 03.00.00 AM', '+261321846915', '+261321289617', 1, 1, 'XXXXXX', 0.2, 0.0);
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 65, 500, 'BA176994768240816010846', 1, 7, '2024-08-16 03.00.00 AM', null, null, 4, 3, 'XXXXXX', 0.0, 0.2);
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 66, 100, 'RCLT251302928240827020827', 1, 2, '2024-08-27 05.53.28 PM', null, null, 8, 2, '01072', 0.0, 0.0);
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 67, 2000, 'RCLT585195203240829080841', 13, 2, '2024-08-29 11.59.41 PM', null, null, 8, 2, '010612', 0.0, 0.0);
INSERT INTO plastikoo2.transaction( id, montant, reference, id_utilisateur, id_machine_recolte, date_transaction, numero_beneficiaire, numero_expediteur, id_service, id_type_transaction, code_recolte, commission_service, commission_plastikoo ) VALUES ( 68, 1000, 'RTT857316819240829090830', 13, 7, '2024-08-30 12.16.30 AM', '+261321846915', '+261321289617', 1, 1, 'XXXXXX', 0.2, 0.0);
