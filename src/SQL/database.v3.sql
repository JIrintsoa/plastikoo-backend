...
ALTER TABLE plastikoo2.photo_publication ADD CONSTRAINT fk_photo_publication_publication FOREIGN KEY ( id_publication ) REFERENCES plastikoo2.publication( id ) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE plastikoo2.reaction_pub ADD CONSTRAINT fk_reaction_to_publication FOREIGN KEY ( id_publication ) REFERENCES plastikoo2.publication( id ) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
BEGIN 
   ...
   VALUES (generate_reference_retrait(),somme, num_benif, num_exp, id_serv,id_user, @id_tt,@id_mr, com_serv); 
...
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil ) VALUES ( 1, 'RANDRIANARISON', 'Johns Irintsoa', 'johnsirintsoa18@gmail.com', 'JIrintsoa', '1234Jo', '2002-09-18', 300, '1234', 0, '2024-08-08 04.16.49 PM', null);
...
INSERT INTO plastikoo2.utilisateur( id, nom, prenom, email, pseudo_utilisateur, mot_de_passe, date_naissance, solde, code_pin, cp_tentative, cp_timestamp_exp, url_profil ) VALUES ( 11, 'Nolan', 'Jackson', 'johns.irintsoa@gmail.com', 'Nolan18', '123Nolan', '2000-08-26', 0, 'XXXX', 0, null, null);
